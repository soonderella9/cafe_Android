...
import com.example.gginiggini.Fragment.MainTab_Cafe2;
import com.example.gginiggini.Fragment.MainTab_Cafe3;
import com.example.gginiggini.Fragment.MainTab_Cafe4;
...
public class Home_PageAdapter extends FragmentStatePagerAdapter {
    ...
    public Fragment getItem(int position) {
        ...
        switch (position) {
            ...
            case 1:
                MainTab_Cafe2 mainTab_Cafe2 = new MainTab_Cafe2();
                return mainTab_Cafe2;
            case 2:
                MainTab_Cafe3 mainTab_Cafe3 = new MainTab_Cafe3();
                return mainTab_Cafe3;
            case 3:
                MainTab_Cafe4 mainTab_Cafe4 = new MainTab_Cafe4();
